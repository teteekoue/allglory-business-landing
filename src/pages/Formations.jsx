  ...
  return (
    <div className="pt-24 pb-20 px-6 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="mt-3 text-[#5c3040] text-lg">Apprenez l’art de la résine époxy avec AllGlory Business</p>
      </div>
      ...
      <div className="glass rounded-3xl p-8 md:p-14">
        <div className="grid md:grid-cols-5 gap-10 items-center">
          <div className="md:col-span-3">
            <img 
              src="/formation-poster.jpg" 
              alt="Affiche de Formation Professionnelle en Résine Époxy" 
              className="w-full rounded-2xl shadow-2xl border border-white/40"
            />
          </div>
          ...
          <div className="md:col-span-2 space-y-6">
            <div>
              ...
              <div className="text-[#ff2d78] text-3xl font-black tracking-tight">RÉSINE ÉPOXY</div>
            </div>
            ...
            <div>
              <div className="font-semibold text-sm tracking-widest mb-3">BONUS EXCLUSIFS</div>
              <div className="flex flex-wrap gap-2 text-xs">
                {["Kit de démarrage offert", "Fiches techniques", "Astuces de pro", "Accompagnement après formation"].map((b,i) => (
                  <div key={i} className="px-4 py-1.5 bg-white/80 rounded-full border">{b}</div>
                ))}
              </div>
            </div>

            <div>
              <div className="text-xs font-medium tracking-widest mb-1">FRAIS</div>
            ...
            <Link to="/contact" className="inline-block mt-4 px-9 py-4 bg-[#ff2d78] hover:bg-[#e6005c] text-white rounded-full font-semibold transition-all">
